    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, help_text='Опишите чем вы занимаетесь', null=True, verbose_name='комментарий')),
                ...
                ('payment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.payment', verbose_name='подписка')),
            ],
            options={
